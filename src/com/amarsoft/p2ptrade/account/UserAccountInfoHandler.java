...
public class UserAccountInfoHandler extends JSONHandler {
	...
	private JSONObject userAccount(JSONObject request)throws HandlerException {
		...
		try {
			...
			BizObject o = m.createQuery("select o.* , a.PHONETEL , a.EMAIL ,a.USERNAME  from o,jbo.trade.user_account a where o.userid = a.userid and  (a.userid = :USERID or a.username=:USERID)").setParameter("USERID",sUserID).getSingleResult(false);
