 ...
 * 借款及担保合同
 * 输入参数：
 * 		SerialNo 流水号(项目编号：project_info.SERIALNO)
 * 		UserID	客户号
 * 输出参数：
 * 		
 */
...
public class ContractBorrowerHandler extends JSONHandler {
	...
	public Object createResponse(JSONObject request, Properties arg1)
		...
		try{
			...
			String sql = "select pi.loanpurpose,o.businesssum,o.loanrate,o.loanterm,o.putoutdate,o.defaultpaydate,o.maturitydate"
					...
					+ " where o.contractserialno=pi.contractid and o.contractserialno=uc.contractid and uc.userid=:UserID and pi.SERIALNO=:SerialNo and uc.relativetype='001'";
			...
			if(obj==null){
				...
				//StringFunction.numberToChinese
				...
				ARE.getLog().debug("pmtmonthfee="+ pmtmonthfee);
